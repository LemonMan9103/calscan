...
class _RecordsPageState extends State<RecordsPage> {
          ...
          return Column(
            children: [
              ...
              if (snapshot.connectionState == ConnectionState.waiting)
                const Expanded(child: Center(child: CircularProgressIndicator(color: Color(0xFFFF7E00))))
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                icon: Icon(
                  Icons.chevron_right,
                  color: _isCurrentMonth ? Colors.grey.shade300 : const Color(0xFFFF7E00),
                ),
                onPressed: _isCurrentMonth ? null : _nextMonth,
              ),
            ],
          ),
          // Monthly calorie summary banner
          if (mealCount > 0) ...[
  ...
  Widget _buildGroupedListView(List<QueryDocumentSnapshot> docs) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        double dailyTotal = dayMeals.fold(0.0, (acc, m) => acc + (m['calories'] as num).toDouble());
  ...
  Widget _buildMealRow(QueryDocumentSnapshot meal, {required bool isLast}) {
    ...
    final portion = meal['portion'] as String? ?? 'General';
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: const Icon(Icons.restaurant_menu, color: Color(0xFFFF7E00), size: 18),
            ),
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              isSearching ? 'No meals match "$_searchQuery"' : 'No records this month',
              style: const TextStyle(
